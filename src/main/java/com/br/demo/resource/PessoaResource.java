...
import com.br.demo.model.service.PessoaService;

@RestController
@RequestMapping("/pessoa")
public class PessoaResource {

	@Autowired // injeta uma pessoaRepository
	...
	@PutMapping("/{codigo}")
	public ResponseEntity<Pessoa> atializar(@PathVariable Long codigo, @Valid @RequestBody Pessoa pessoa) {
